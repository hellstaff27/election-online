...
class RegistForm(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'ser': forms.TextInput(attrs = {'class': 'form-control text-center', 'placeholder': '1448', 'maxlength' : 4}),
			'num': forms.TextInput(attrs = {'class': 'form-control text-center', 'placeholder': '123456', 'maxlength' : 6}),
